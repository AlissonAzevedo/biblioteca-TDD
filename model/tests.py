...
class TestBiblioteca(TestCase):
    ...
    def test_verificar_livro_ja_emprestado(self):
        ...
        empresto1 = Emprestimo(Usuario('usuario1', '00000000000'), livro1)

        livro2 = Livro(2, 'livro2')
        empresto2 = Emprestimo(Usuario('usuario2', '00000000001'), livro2)
    ...
    def test_devolver_livro_nao_emprestado(self):
        ...
        usuario1 = Usuario('usuario1', '00000000002')
        livros_usuario1 = [livro1, livro2]

        funcionario1 = Funcionario('funcionario1', '00000000040')
        biblioteca.funcionarios = [funcionario1]
        biblioteca.realizarEmprestimo(funcionario1, livros_usuario1, usuario1)

        #self.assertEqual(biblioteca.realizarDevolucao(funcionario1, livro3), "Devolucao nao realizada pois o livro nao encontra-se emprestado")
    ...
    def test_limitar_usuario_de_pegar_no_maximo_3_livros(self):
        ...
        usuario1 = Usuario('usuario1', '00000000002')
        usuario2 = Usuario('usuario2', '00000000004')
    ...
    def test_solicitar_emprestimo_com_funcionario_invalido(self):
        ...
        usuario1 = Usuario('usuario1', '00000000002')
        funcionario1 = Funcionario('funcionario1', '00000000003')
